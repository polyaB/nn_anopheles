...
# pickle_model = "train_dataset_['3L'].pickle"
pickle_model = "test_dataset_['3L'].pickle"
# pickle_model = "test_dataset_14.07.pickle"
...
with open("/mnt/scratch/ws/psbelokopytova/202011291709Polya_data/nn_anopheles/output/"+pickle_model, 'rb') as f:
...
# test.to_dict()
# train.to_dict()
# with open("/mnt/scratch/ws/psbelokopytova/202011291709Polya_data/nn_anopheles/output/train_X_15.07", 'wb') as f:
#     pickle.dump(train, f)
# with open("/mnt/scratch/ws/psbelokopytova/202011291709Polya_data/nn_anopheles/output/test_X_15.07", 'wb') as f:
#     pickle.dump(test, f)
