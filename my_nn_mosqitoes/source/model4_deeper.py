...
def build_feature_extractor(
    ...
    current = conv_block_3x(current, filters=1024, kernel_size=3, dilation_rate=1, pool_size=2, batch_norm=True,
                            activation='elu')
    current = conv_block_3x(current, filters=2048, kernel_size=3, dilation_rate=1, pool_size=2, batch_norm=True,
                            activation='elu')
    current = conv_block_3x(current, filters=4096, kernel_size=3, dilation_rate=1, pool_size=2, batch_norm=True,
                            activation='elu')
    # current = conv_block_3x(current, filters=8192, kernel_size=3, dilation_rate=1, pool_size=2, batch_norm=True,
    #                         activation='elu')
